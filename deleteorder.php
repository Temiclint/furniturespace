...
<?php 
  ...
  <div class="productsection" id ="productgallery">
   ...
   <h2 class="datetime">  
    ...
    <form class="srcrecordfrm" action="deleteoconfirm.php" method="POST">
            <h3 class="orderhead" width='70%'>Delete</h3>
            <label for="ordid" class="order-label">Enter Order id</label><br>
            <input type="text" class="order-inpttext" name="ordid" value=""><br>
