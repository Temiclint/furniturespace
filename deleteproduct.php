...
<?php 
  ...
  <div class="productsection" id ="productgallery">
   ...
   <h2 class="datetime">  
    ...
    <form class="srcrecordfrm" action="deletepconfirm.php" method="POST">
            <h3 class="orderhead" width='70%'>Delete</h3>
            <label for="prdid" class="order-label">Enter product id</label><br>
            <input type="text" class="order-inpttext" name="prdid" value=""><br>
